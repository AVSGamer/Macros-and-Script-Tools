...
Run, C:\Users\Lorman\Dropbox\PC\Documents\Macros\LeftJoystick2MouseWired.ahk

; Activation/Toggle Mod Bool
Mousemode = 0
firstRun = 0
...
if MouseNeedsToBeMoved
{
	...
	DllCall("SetCursorPos", "int", 960 + (DeltaX * JoyMultiplier * 68), "int", 540 + (DeltaY * JoyMultiplier * YAxisMultiplier * 38))
}
return
